...
if __name__ == '__main__':
    ...
    a = e_field.e_field_gen(3, False, ampl_1*FIELD_AMP, 0*FIELD_AMP,
                            0*FIELD_AMP, 0,
                            0/FUND_FREQ, 0/FUND_FREQ,
                            FUND_FREQ, 2*FUND_FREQ, 3*FUND_FREQ,
                            [[0], [hwp_2, qwp_2], [hwp_3, qwp_3]],
                            PL_FWHM, PL_FWHM, PL_FWHM,
                            b1='q', b2='hq', b3='hq')
