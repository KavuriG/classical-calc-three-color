...
def plot(closest, time_grid, field):
    ax1.clear()


    y_field = 0.6E-9*field[0](time_grid)/FIELD_AMP + 0.6E-9
    l1 = ax1.plot(time_grid, y_field, color='#310C0C')
    l2 = ax1.plot(time_grid, closest, '.',color='#c9803c' )
    #l2 = ax1.plot(time, kin_en, 'g')
    ax1.set_ylim(-0.1E-9, 1E-9)
